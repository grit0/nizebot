...
handler = WebhookHandler('c480e59b1556f1597bb16595534bb936')
...
#     x= ImageSendMessage(
#         original_content_url='https://cloud.google.com/vision/images/rushmore.jpg',
#         preview_image_url='https://cloud.google.com/vision/images/rushmore.jpg'
# )
#     if(event.message.text=="สัส"):
#         line_bot_api.reply_message(event.reply_token,TextSendMessage(text="ฆวยไร"))
#     elif(event.message.text=="."):
#         line_bot_api.reply_message(event.reply_token,x)
#     else:
